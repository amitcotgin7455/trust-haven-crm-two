                            ...
                            <div class="tab-content">
                                <div id="scheduled" class="tab-pane active">                             
                                    <div class="table-titles pb-4 px-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6>Total Stop Email <?= $total_row ;?></h6>           
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 px-5 py-2">
                                            <form action="<?=base_url();?>sales/list-massemail/" method="get">
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <input name="stopped" class="d-none" type="text" value="1">
                                        ...
                                        <table class="table table-hover table-responsive-lg" style="width:100%">
                                            ...
                                            <tbody id="data-show">                                    
                                                ...
                                                <tr id="sub_chk_draft" >                                               
                                                    ...
                                                    <td><?= date('m-Y-d h:i A',strtotime($sent->mod_date)) ;?></td>
                                                    <td>Stopped</td>  
                                                </tr>                                    
                                                <?php } }else{ ?>
                                                    <tr></tr>
