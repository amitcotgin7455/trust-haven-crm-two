                            ...
                            <div class="tab-content">
                                <div id="scheduled" class="tab-pane active">                             
                                    <div class="table-titles pb-4 px-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6>Total Scheduled Email <?= $total_row;?></h6>           
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 px-5 py-2">
                                            <form action="<?=base_url();?>sales/list-massemail/" method="get">
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <input name="scheduled" class="d-none" type="text" value="1">
                                        ...
                                        <table class="table table-hover table-responsive-lg" style="width:100%">
                                            <thead id="data-heading-show">
                                                <tr>                                            
                                                    ...
                                                    <th width="25%">Date Time Scheduled</th>
                                            ...
                                            <tbody id="data-show">                                    
                                                ...
                                                <tr id="sub_chk_draft" >                                               
                                                    <td> <a href="<?php echo base_url();?>sales/update-massemail?id=<?php echo base64_encode($sent->listid);?>"> <?= $sent->username;?></a></td>
                                                    <td><?php if($sent->template_id==1){ echo 'Cancellation';}elseif($sent->template_id==2){ echo 'Follow Up';}else{ echo 'Schedule';}?></td>
                                                    <td><?= date('m-Y-d',strtotime($sent->schedule_date)) ;?> / <?= date('h:i A',strtotime($sent->schedule_time)) ;?></td>
                                                    <td>Schedule</td>  
                                                </tr>                                    
                                                <?php } }else{ ?>
                                                    <tr></tr>
