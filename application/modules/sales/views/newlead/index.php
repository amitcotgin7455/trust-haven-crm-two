...
if (!empty($editResult[0]->lead_id)) {
    $frmaction = base_url() . "sales/NewLead/updateNewLead";
    $buttoName = 'Save Changes';
    $BtnClass = 'btn btn-raised gradient-mint white shadow-z-4';
} else {
    $frmaction = base_url() . "sales/NewLead/addNewLead";
    $buttoName = 'Add Lead';
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="customer-header d-flex justify-content-between">
                    <div class="right">
                        <div class="myHeading">
                            <a href="<?php echo base_url(); ?>sales/list-newlead">
...
<section class="customer-information my-2">
    <div class="my-5">
        ...
        <?php if(empty($name)){?> Fill <?php } ?> New Lead Information
        </h1>
    </div>
    <div class="container-fluid my-2">
        <div class="row">
                ...
                <form method="POST" action="<?php echo $frmaction; ?>" id="customer" onsubmit=" return valid();">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="d-flex">
                                <div class="pt-2 ps-4 position-relative">
                                    <label class="form-label" for="form6Example1">Time Zone<span class="text-danger">*</span></label>
                                </div>
                                <div class="px-4 position-relative">
                                    <div class="input-group <?php if (!empty($name)) {echo 'hoverable';} ?>">
            ...
            <?php if (!empty($lead_id)) { ?>
                ...
                <div class="col-lg-9 border my-5 " id="email-down">
...
<form action="<?php echo base_url(); ?>sales/NewLead/mail" method="post">
...
<script>
    $('#saveEmpForm').submit('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>sales/NewLead/save",
            //dataType : "JSON",
            data: {
                lead_id: lead_id,
                note: note
...
<script>
    ...
    function listEmployee() {
        ...
        $.ajax({
            type: 'ajax',
            url: '<?php echo base_url(); ?>sales/NewLead/show/?id=' + lead_id + '',
            async: false,
            dataType: 'json',
            success: function(data) {
                var html = '';
...
<script>
    ...
    $('#deleteEmpForm').on('submit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>sales/NewLead/delete",
            dataType: "JSON",
            data: {
                id: empId
            },
...
<script>
    ...
    $('#editEmpForm').on('submit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>sales/NewLead/updatenote",
            // dataType: "JSON",
            data: {
                id: empId,
                note: empName
    ...
    $(document).ready(function() {
        $("#button_1").click(function(e) {
            ...
            if(too == '' ){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>sales/NewLead/emaildraft",
                    //dataType : "JSON",
                    data: {
                        too: too,
                        cc: cc,
...
<script>
    function insertTemplate(template_id) {
        ...
        let id = template_id;
        $.ajax({
            url: "<?php echo base_url(); ?>sales/NewLead/fetchtemplate",
            type: "POST",
            // sending data
            data: {
                template_id: id,
        ...
        $('.delete_all').on('click', function(e) {
            ...
            if (allVals.length <= 0) {
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>sales/NewLead/DeleteEmail",
                        type: 'POST',
        ...
        $('.delete_all_draft').on('click', function(e) {
            ...
            if (allVals.length <= 0) {
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>sales/NewLead/DeleteEmaildraft",
                        type: 'POST',
                        data: 'ids=' + join_selected_values,
                        success: function(data) {
                            console.log(data);
...
<script>
    $('.saveupdatefilled').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>sales/NewLead/updateformfilled",
            data: {
                hidden_id: $hidden_id,
                name: $name,
