                ...
                <div class="customer-header d-flex justify-content-between">
                    ...
                    <div class="btn-group me-3" role="group">
                        ...
                        <div class="myHeading">
                            <?php if ($role_id == 1 || $role_id == 4) { ?>
                                <form action="<?php echo base_url(); ?>sales/list-newlead" method="get">
                    ...
                    <div class="left align-items-center">
                            <div class="btn-group" role="group">
                                <a href="<?php echo base_url(); ?>sales/create-newlead/" class="btn theme-btn-2">Add New Leads </a>
                            </div>
                            <div class="btn-group">
                            <div class="dropdown">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-xl-2">
                <div class="mt-3" id="leftCol">
                    <h2 class="heading-filter text-center py-2">Filter New Leads by </h2>
                    <div id="content">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse  " data-bs-parent="#accordionExample">
                                <form action="<?php echo base_url(); ?>sales/list-newlead" method="post">
                                        ...
                                        <div class="form-check user-system-dropdown">
                                            ...
                                            <div class="user-system " id="actions" hidden>
                                                <div class="ac-dropdown d-flex justify-content-around">
                                                    <span class="mt-2 " style="font-size: 14px;"> By </span>
                                                    <select class="form-select form-select-md ms-1" aria-label=".form-select-sm example" name="lead-status">
                                                ...
                                                <div class="second-select d-flex justify-content-evenly mt-2">
                                                    <select class="form-select form-select-md" id="time-range" aria-label=".form-select-sm example" name="time-range">
                                                    ...
                                                    <select class="form-select form-select-md" id="time-unit" aria-label=".form-select-sm example" name="getdays">
                ...
                <div class="mt-3">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <h2 class="text-center">New Lead Data </h2>
                            </div>
                        </div>
                                    ...
                                    <?php if (!empty($result)) {
                                     ...
                                     ?>
                                            <tr id="sub_chk_draft" >
                                                ...
                                                <td><?php echo $n; ?></td>
                                                <td><a href="<?php echo base_url(); ?>sales/update-newlead/?id=<?php echo base64_encode($row->lead_id); ?>"><img src="<?php echo base_url(); ?>assets/lead/front_assets/assets/images/user.png" class="avatar" alt="Avatar"> <?php echo $row->name; ?> </a></td>
                                                <td><?php echo $row->last_name; ?> </td>
                                                <td><?php echo $row->email; ?> </td>
                                                <td><?php echo $row->phone; ?></td>
                                                <td><?php echo $row->other_phone; ?></td>
                                                <!-- <td><?php echo date("m-d-Y h:i A",strtotime($row->date_of_sale)); ?></td> -->
                                                <td <?php if($row->lead_status==2){ echo 'class="text-danger"';} ?> ><?php if($row->lead_status==1) { echo 'Callback';}elseif($row->lead_status==2){echo 'Sale';}elseif($row->lead_status==3){ echo 'Not interested';}elseif($row->lead_status==4){echo 'VM';}else{ echo 'DND';} ?></td>
                                            </tr>
                                    <?php $n++;
                                        }
                                    } ?>
        ...
        $('.delete_all_draft').on('click', function(e) {
            ...
            if (allVals.length <= 0) {
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>sales/NewLead/deletelead",
                        type: 'POST',
