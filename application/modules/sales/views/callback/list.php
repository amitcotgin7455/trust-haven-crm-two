                ...
                <div class="customer-header d-flex justify-content-between">
                    ...
                    <div class="btn-group me-3" role="group">
                        ...
                        <div class="myHeading">
                            <?php if ($role_id == 1 || $role_id == 4) { ?>
                                <form action="<?php echo base_url(); ?>sales/list-callback" method="get">
                    ...
                    <div class="left align-items-center">
                            <div class="btn-group" role="group">
                                <a href="<?php echo base_url(); ?>sales/create-callback/" class="btn create_lead theme-btn-2">Add Callback </a>
                            </div>
                            <div class="btn-group">
                            <div class="dropdown">
        ...
        <div class="row">
            <div class="col-xl-2 col-lg-3">
                <div id="leftCol" class="mt-3">
                    <h2 class="heading-filter text-center py-2">Filter Callback by </h2>
                    <div id="content">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse  " data-bs-parent="#accordionExample">
                                <form action="<?php echo base_url(); ?>sales/list-callback" method="post">
                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <h2 class="text-center">Callback Data </h2>
                                    ...
                                    <?php if (!empty($result)) {
                                     ...
                                     ?>
                                            <tr id="sub_chk_draft" >
                                                ...
                                                <td><?php echo $n; ?></td>
                                                <td><a href="<?php echo base_url(); ?>sales/update-callback/?id=<?php echo base64_encode($row->lead_id); ?>"><img src="<?php echo base_url(); ?>assets/lead/front_assets/assets/images/user.png" class="avatar" alt="Avatar"> <?php echo $row->name; ?> </a></td>
        ...
        $('.delete_all_draft').on('click', function(e) {
            ...
            if (allVals.length <= 0) {
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>sales/Callback/deletelead",
                        type: 'POST',
