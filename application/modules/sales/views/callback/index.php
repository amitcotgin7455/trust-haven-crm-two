...
if (!empty($editResult)) {
    ...
    foreach ($editResult as $value) {
        ...
        $lead_callback_date = $value->lead_callback_date;
...
if (!empty($editResult[0]->lead_id)) {
    $frmaction = base_url() . "sales/Callback/updateCallback";
    $buttoName = 'Save Changes';
    $BtnClass = 'btn btn-raised gradient-mint white shadow-z-4';
} else {
    $frmaction = base_url() . "sales/Callback/addCallback";
    $buttoName = 'Add Lead';
...
if(!empty($exist_lead_detail))
{
        ...
        $lead_callback_date = $exist_lead_detail->lead_callback_date;
        $callback_time = $exist_lead_detail->callback_time;
        $time_zone = $exist_lead_detail->time_zone;
}
if($date_of_sale)
{
...
if($lead_callback_date)
{
$expiry_date_exp =  explode('-',$lead_callback_date);
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="customer-header d-flex justify-content-between">
                    <div class="right">
                        <div class="myHeading">
                            <a href="<?php echo base_url(); ?>sales/list-callback">
...
<section class="customer-information my-2">
    <div class="my-5">
        ...
        <?php if(empty($name)){?> Fill <?php } ?> Callback Information
        </h1>
    </div>
                ...
                <form method="POST" action="<?php echo $frmaction; ?>" id="customer"  onsubmit=" return valid();">
                    ...
                    <div class="row ">                        
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="d-flex">
                                <div class="pt-2 ps-4 position-relative">
                                    <label class="form-label" for="form6Example1">Date of Sale<?php /*<span class="text-danger">*</span> */ ?></label>
                                </div>
                                <div class="px-4 position-relative">
            ...
            <span class="input-group-addon"> 
                <i class="glyphicon glyphicon-calendar"></i> 
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="d-flex">
                                <div class="pt-2 ps-4 position-relative">
                                    <label class="form-label" for="form6Example1">Callback Date<span class="text-danger">*</span></label>
                                </div>
                                <div class="px-4 position-relative">
                                    <div class="input-group <?php if (!empty($name)) { echo 'hoverable'; } ?> date" >
                                        <!-- <input type="date" class="form-control setinput"  name="lead_callback_date" value="<?php if (!empty($lead_callback_date)) { echo $lead_callback_date; } else { echo set_value('lead_callback_date'); } ?>" id="lead_callback_date" <?php if(!empty($lead_callback_date)) echo 'required';?>> -->
                                            <!-- <span class="fa fa-edit xl mt-3 editable"></span> -->
                                            <div id="contact_exp_date" style="width: 346px;padding-left: 24px;" 
             class="input-group date" 
             data-date-format="mm-dd-yyyy"> 
            <input class="form-control date-input" 
                   type="text" name="lead_callback_date"  id="txtDate"/> 
            <span class="input-group-addon"> 
                <i class="glyphicon glyphicon-calendar"></i> 
            </span> 
                                        </div>
                                    ...
                                    <span class="text-danger"><?php echo form_error('lead_callback_date'); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="d-flex">
                                <div class="pt-2 ps-4 position-relative">
                                    <label class="form-label" for="form6Example1">Callback Time</label>
                                </div>
                                <div class="px-4 position-relative">
                                    <div class="input-group <?php if (!empty($name)) { echo 'hoverable'; } ?> date" >
                                        <input type="time" class="form-control setinput"  name="callback_time" value="<?php if (!empty($callback_time)) { echo $callback_time; } else { echo set_value('callback_time'); } ?>" id="callback_time" <?php if(!empty($callback_time)) echo 'required';?>>
                                            <!-- <span class="fa fa-edit xl mt-3 editable"></span> -->
                                        <div class="input-group-addon">
                                            <span class="input-group-text bg-white d-block">
                                                <!-- <box-icon name='calendar' type='solid' color='#313949'></box-icon> -->
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 512 512" xml:space="preserve" class="hovered-paths"><g><path d="M12 1a11 11 0 1 0 11 11A11.013 11.013 0 0 0 12 1zm0 20a9 9 0 1 1 9-9 9.011 9.011 0 0 1-9 9z" fill="#313949" data-original="#000000" opacity="1" class="hovered-path"></path><path d="M13 11.586V6a1 1 0 0 0-2 0v6a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414z" fill="#313949" data-original="#000000" opacity="1" class="hovered-path"></path></g></svg>
                                            </span>
                                        </div>
                                        <!-- <span class="fa fa-check mx-3 mt-3 text-success d-none savechanges saveupdatefilled"></span>
                                        <span class="fa fa-close  mt-3 text-danger d-none savechanges crossicon"></span> -->
                                    </div>
                                    <span class="text-danger"><?php echo form_error('callback_time'); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="d-flex">
                                <div class="pt-2 ps-4 position-relative">
                                    <label class="form-label" for="form6Example1">Time Zone</label>
                                </div>
                                <div class="px-4 position-relative">
                                    <div class="input-group <?php if (!empty($name)) {echo 'hoverable';} ?>">
                                        <select class="form-select setinput form-select-sm" aria-label=".form-select-sm example" name="time_zone" id="time_zone" <?php if(!empty($time_zone)) echo 'required';?>>
                                            <option value="">Time Zone</option>
                                            <option value="1" <?php if ($time_zone == 1) { echo 'selected';} elseif(set_value('time_zone')==1){ echo  'selected';}else{} ?>> PST</option>
                                            <option value="2" <?php if ($time_zone == 2) {echo 'selected';} elseif(set_value('time_zone')==2){ echo  'selected';}else{} ?>>MST</option>
                                            <option value="3" <?php if ($time_zone == 3) {echo 'selected';} elseif(set_value('time_zone')==3){ echo  'selected';}else{} ?>>CST</option>
                                            <option value="4" <?php if ($time_zone == 4) { echo 'selected'; } elseif(set_value('time_zone')==4){ echo  'selected';}else{} ?>>EST</option>
                                        </select>
                                            <!-- <span class="fa fa-edit xl mt-3 editable"></span> -->
                                        <div class="input-group-addon">
                                            <span class="input-group-text bg-white d-block">
                                                <!-- <img src="<?php echo base_url(); ?>assets/lead/front_assets/assets/images/conversion-rate.png" alt=""> -->
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="M489.646 276.761c.607-6.866 1.021-13.8 1.021-20.761C490.667 126.6 385.4 21.333 256 21.333S21.333 126.6 21.333 256a231.74 231.74 0 0 0 11.136 71.3C63.417 425.016 153.25 490.667 256 490.667a233.117 233.117 0 0 0 66.49-9.785 137.751 137.751 0 0 0 50.843 9.785C449.792 490.667 512 428.464 512 352a137.738 137.738 0 0 0-22.354-75.239Zm-101.534-62.615h55.154a191.211 191.211 0 0 1 3.461 20.418 137.539 137.539 0 0 0-58.615-20.418ZM256 448c-18.755 0-43.882-39.877-56.286-105.812h35.45c-.229 3.254-.5 6.5-.5 9.812a138.038 138.038 0 0 0 38.138 95.23c-5.564.482-11.163.77-16.802.77Zm-10.948-148.479H194.1c-1.245-14.16-2.1-28.612-2.1-43.521 0-14.634.591-28.6 1.677-41.854h124.49c.281 3.4.534 6.838.748 10.34a139.41 139.41 0 0 0-73.863 75.035Zm-176.035 0a189.349 189.349 0 0 1-.283-85.375h82.276A527.566 527.566 0 0 0 149.333 256c0 14.843.785 29.306 1.927 43.521ZM256 64c18.7 0 44.253 39.669 56.617 107.479H199.3C211.573 104.134 236.917 64 256 64Zm172.133 107.479h-72.224c-5.7-34.782-15.078-67.487-28.221-93.458a192.9 192.9 0 0 1 100.445 93.458Zm-243.1-93.722c-13.216 25.809-22.892 58.455-28.8 93.722H83.867a192.867 192.867 0 0 1 101.168-93.722ZM84.415 342.188h71.871c6.122 36.84 15.787 67.966 28.188 92.052a190.423 190.423 0 0 1-100.059-92.052ZM373.333 448a96 96 0 1 1 96-96 96.109 96.109 0 0 1-96 96Z" fill="#313949" data-original="#000000" opacity="1" class=""></path><path d="M416 330.667h-21.333v-32a21.334 21.334 0 1 0-42.667 0V352a21.334 21.334 0 0 0 21.333 21.333H416a21.333 21.333 0 0 0 0-42.666Z" fill="#313949" data-original="#000000" opacity="1" class=""></path></g></svg>
                                            </span>
                                        </div>
                                        <!-- <span class="fa fa-check mx-3 mt-3 text-success d-none savechanges saveupdatefilled"></span>
                                        <span class="fa fa-close  mt-3 text-danger d-none savechanges crossicon"></span> -->
                            ...
                            <div class="d-flex">
                                ...
                                <div class="px-4 position-relative">
                                    <div class="input-group <?php if (!empty($name)) {echo 'hoverable';} ?>">
                                        ...
                                        <div class="input-group-addon">
                                            <span class="input-group-text bg-white d-block">
                                                <!-- <img src="<?php echo base_url(); ?>assets/lead/front_assets/assets/images/padlock.png" alt=""> -->
                            ...
                            <div class="d-flex">
                                ...
                                <div class="px-4 position-relative">
                                    <div class="input-group <?php if (!empty($name)) { echo 'hoverable'; } ?>">
                                        ...
                                        <div class="input-group-addon">
                                            <span class="input-group-text bg-white d-block">
                                                <!-- <img src="<?php echo base_url(); ?>assets/lead/front_assets/assets/images/exclamation.png" alt=""> -->
                            ...
                            <div class="d-flex">
                                ...
                                <div class="px-4 position-relative">
                                    <div class="input-group <?php if (!empty($name)) { echo 'hoverable'; } ?>">
                                        ...
                                        <div class="input-group-addon">
                                            <span class="input-group-text bg-white d-block">
                                                <!-- <img src="<?php echo base_url(); ?>assets/lead/front_assets/assets/images/detail.png" alt=""> -->
                        ...
                        <?php if($lead_status != 2 && !empty($lead_id)){ ?> 
                        <div class="col-md-6 mb-4">
                            <div class="d-flex">
                                <div class="pt-2 ps-4 position-relative">
...
<form action="<?php echo base_url(); ?>sales/Callback/mail" method="post">
        ...
        <div class="modal-dialog modal-del">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn newgraybtn" data-bs-dismiss="modal">No</button>
...
<form id="editEmpForm" method="post">
    <div class="modal" id="editEmpFormmodel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editEmpFormmodelLabel" aria-hidden="true">
        <div class="modal-dialog modal-edit">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="editEmpFormmodelLabel">Edit Notes</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
<script>
    $('#saveEmpForm').submit('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>sales/Callback/save",
            //dataType : "JSON",
            data: {
                lead_id: lead_id,
                note: note
...
<script>
    ...
    function listEmployee() {
        ...
        $.ajax({
            type: 'ajax',
            url: '<?php echo base_url(); ?>sales/Callback/show/?id=' + lead_id + '',
            async: false,
            dataType: 'json',
            success: function(data) {
                var html = '';
...
<script>
    ...
    $('#deleteEmpForm').on('submit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>sales/Callback/delete",
            dataType: "JSON",
            data: {
                id: empId
            },
...
<script>
    ...
    $('#editEmpForm').on('submit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>sales/Callback/updatenote",
            // dataType: "JSON",
            data: {
                id: empId,
                note: empName
    ...
    $(document).ready(function() {
        $("#button_1").click(function(e) {
            ...
            if(too == '' ){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>sales/Callback/emaildraft",
                    //dataType : "JSON",
                    data: {
                        too: too,
                        cc: cc,
...
<script>
    function insertTemplate(template_id) {
        ...
        let id = template_id;
        $.ajax({
            url: "<?php echo base_url(); ?>sales/Callback/fetchtemplate",
            type: "POST",
            // sending data
            data: {
                template_id: id,
        ...
        $('.delete_all').on('click', function(e) {
            ...
            if (allVals.length <= 0) {
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>sales/Callback/DeleteEmail",
                        type: 'POST',
        ...
        $('.delete_all_draft').on('click', function(e) {
            ...
            if (allVals.length <= 0) {
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>sales/Callback/DeleteEmaildraft",
                        type: 'POST',
                        data: 'ids=' + join_selected_values,
                        success: function(data) {
                            console.log(data);
...
<script>
    $('.saveupdatefilled').on('click', function() {
        ...
        $name = $('#name').val();
        $lead_callback_date = $('#lead_callback_date').val();
        $phone = $('#phone').val();
        $payment = $('#payment').val();
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>sales/Callback/updateformfilled",
            data: {
                hidden_id: $hidden_id,
                name: $name,
