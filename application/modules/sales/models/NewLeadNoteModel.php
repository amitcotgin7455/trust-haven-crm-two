<?php
class NewLeadNoteModel extends CI_Model{

// admin new model 
public function getResultAdmin(){
	$this->db->where('status',1);
	$this->db->group_start();
	$this->db->where('type_of_lead',3);
...
public function getdatedays($getnumber){
	...
	$sql = "select * from tbl_leads WHERE created_at>= DATE_ADD(CURDATE(), INTERVAL -'$getnumber' DAY) AND status = 1 AND type_of_lead=3";
...
public function getdateweek($getnumber){
	...
	$sql="select * from tbl_leads WHERE created_at>= DATE_ADD(NOW(), INTERVAL -'$getnumber' WEEK) AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}
...
public function getdatemonths($getnumber){
	...
	$sql="select * from tbl_leads WHERE created_at>= DATE_ADD(NOW(), INTERVAL -'$getnumber' MONTH) AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}

public function getFromToo($from1,$too1){
	$sql = "SELECT * FROM tbl_leads WHERE created_at BETWEEN '$from1' AND '$too1' AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);	   
	return $query->result();
 }
 ...
 public function getdatetoday(){
	...
	$sql="select * from tbl_leads where date(created_at) = CURDATE() AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);
...
public function getdateThisweek(){
	$sql="SELECT * FROM tbl_leads WHERE WEEK(created_at) = WEEK(CURRENT_DATE()) AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}

public function getdateThismonth(){
	$sql="SELECT * FROM tbl_leads WHERE MONTH(created_at) = MONTH(CURRENT_DATE()) AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}

public function getdateThisyear(){
	$sql="SELECT * FROM tbl_leads WHERE YEAR(created_at) = YEAR(CURRENT_DATE()) AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}
...
public function getLast30days(){
	...
	$sql = "select * from tbl_leads WHERE created_at>= DATE_ADD(CURDATE(), INTERVAL -'30' DAY) AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
...
public function getLast60days(){
	...
	$sql = "select * from tbl_leads WHERE created_at>= DATE_ADD(CURDATE(), INTERVAL -'60' DAY) AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
...
public function getLast90days(){
	...
	$sql = "select * from tbl_leads WHERE created_at>= DATE_ADD(CURDATE(), INTERVAL -'90' DAY) AND status = 1 AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
...
public function getdatedays_user($getnumber,$id){
	...
	$sql = "select * from tbl_leads WHERE created_at>= DATE_ADD(CURDATE(), INTERVAL -'$getnumber' DAY) AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
...
public function getdateweek_user($getnumber,$id){
	...
	$sql="select * from tbl_leads WHERE created_at>= DATE_ADD(NOW(), INTERVAL -'$getnumber' WEEK) AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}
...
public function getdatemonths_user($getnumber,$id){
	...
	$sql="select * from tbl_leads WHERE created_at>= DATE_ADD(NOW(), INTERVAL -'$getnumber' MONTH) AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}

public function getFromToo_user($from1,$id,$too1){
	$sql = "SELECT * FROM tbl_leads WHERE created_at BETWEEN '$from1' AND '$too1' AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);	   
	return $query->result();
 }
 ...
 public function getdatetoday_user($id){
	...
	$sql="select * from tbl_leads where date(created_at) = CURDATE() AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
...
public function getdateThisweek_user($id){
	$sql= "SELECT * FROM tbl_leads WHERE WEEK(created_at) = WEEK(CURRENT_DATE()) AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}

public function getdateThismonth_user($id){
	$sql= "SELECT * FROM tbl_leads WHERE MONTH(created_at) = MONTH(CURRENT_DATE()) AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}

public function getdateThisyear_user($id){
	$sql= "SELECT * FROM tbl_leads WHERE YEAR(created_at) = YEAR(CURRENT_DATE()) AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
}
...
public function getLast30days_user($id){
	...
	$sql = "select * from tbl_leads WHERE created_at>= DATE_ADD(CURDATE(), INTERVAL -'30' DAY) AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
...
public function getLast60days_user($id){
	...
	$sql = "select * from tbl_leads WHERE created_at>= DATE_ADD(CURDATE(), INTERVAL -'60' DAY) AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
...
public function getLast90days_user($id){
	...
	$sql = "select * from tbl_leads WHERE created_at>= DATE_ADD(CURDATE(), INTERVAL -'90' DAY) AND status = 1 AND user_id = $id AND type_of_lead=3";
	$query = $this->db->query($sql);
	return $query->result();
