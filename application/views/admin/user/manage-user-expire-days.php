                                                    ...
                                                    <?php if (!empty($result)) {
                                                        ...
                                                        foreach ($result as $row) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?=($row->cookies_expire_time)?date('M d Y H:i:s',strtotime($row->cookies_expire_time)):''; ?></td>
                                                                <td><?= $row->location ?></td>
                                                                <td  class="text-center"><?php if($row->cookie_expire_status==3) { ?> Logged Out <?php } else { ?> <a href="<?=base_url()?>user_management/user-cookie-logout?auth_id=<?=base64_encode($row->id)?>" class="btn btn_save" onclick="return confirm ('Are you sure. Logout this user??');"     ><i class="fa fa-sign-out"></i></a><?php } ?></td>
                                                                
                                                                <td  class="text-center"><a href="<?=base_url()?>user_management/user-login-activity?auth_id=<?=base64_encode($row->id)?>"><i class="fa fa-eye" style="color:#b41e45" ></i></a></td>
                                                            </tr>
                                                    <?php $n++;
                                                        }
                                                    } ?>
