                                ...
                                <div class="d-flex align-items-start">
                                    <div class="tab-content w-100" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                                            <div class="row">
                                                <form action="<?php echo base_url('custom_field/addWork'); ?>" method="POST">
                                                    <div class="row mt-3">
                                                        <div class="form-group col-md-6">
                                                            <div class="mb-3">
                                                                <label class="form-label">Work Status</label>
                                                                <input type="text" class="form-control" name="title" value="<?php if($edit_id) { echo $work_status->title; } else { echo set_value('title'); } ?>">
                                                                <?php
                                                                if($edit_id)
                                                                {
                                                                ?>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="status" class="form-select">
                                                                    <option value="1" <?php if(@$work_status->status==1) { echo 'selected'; } ?>>Active</option>
                                                                    <option value="2" <?php if(@$work_status->status==2) { echo 'selected'; } ?>>InActive</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
