...
<div class="second_header">
    <div class="container-fluid ">
        <div class="row justify-content-between align-content-center">
            <div class="col-6">
                <h5 class="d-inline">Detail Lead</h5>
            </div>
            <div class="col-6">
                <div class="leads-btn mb-2">
                    <a href="javascript:void(0)" class="btn btn_save sendmailbtn" id="<?php echo $lead_detail->id; ?>" data-bs-toggle="modal" data-bs-target="#myModal"> Send Email </a>
                    <!-- <a href="javascript:void(0)" class="btn button_btn">Convert</a> -->
                    <a href="<?php echo base_url(); ?>update-lead?id=<?php echo base64_encode($lead_detail->id); ?>" class="btn button_btn"> Edit</a>
                                        ...
                                        <div class="detail-box">
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="px-4 position-relative">
                                                    <input type="hidden" value="<?php if (!empty($lead_detail->id)) {
                                                                                    echo $lead_detail->id;
                                                                                } ?>" id="hidden_id">
                                                    <input class="form-control" value="<?php if (!empty($lead_detail->first_name)) {
                                                                                            echo $lead_detail->first_name;
                                                    ...
                                                    <span class="check-close d-flex">
                                                        ...
                                                        <a href="javascript:void(0)" class="check-input-check"> <i class="fa-solid fa-check"></i></a>
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="px-4 position-relative">
                                                    <input class="form-control" value="<?php if (!empty($lead_detail->mobile_1)) {
                                                                                            echo $lead_detail->mobile_1;
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="px-4 position-relative">
                                                    <input class="form-control" value="<?php if (!empty($lead_detail->email)) {
                                                                                            echo $lead_detail->email;
                                                                                        } ?>" type="email" id="email">
                                                    <i id="edit-field1" class="edit-field fa-solid fa-pencil none-icon"></i>
                                                    <span class="check-close d-flex">
                                                        <a class="close-input-xmark" href="javascript:void(0)"><i class="fa-solid fa-xmark"></i></a>
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="px-4 position-relative">
                                                    <p class="pt-2 px-3"> <span id="user_name"><?php echo $lead_added_name; ?></span> <br><span class="date-time-day"> <?php if (!empty($lead_detail->created_date)) {
                                                                                                                                                                            echo date('m-d-Y g:i A', strtotime($lead_detail->created_date));
                                                                                                                                                                        } ?></span></p>
                                                </div>
                                            </div>
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="px-4 position-relative">
                                                    <textarea class="form-control" id="description"><?php if (!empty($lead_detail->description)) {
                                                                                                        echo $lead_detail->description;
                                                                                                    } ?></textarea>
                                                    <i id="edit-field1" class="edit-field fa-solid fa-pencil none-icon"></i>
                                                    <span class="check-close d-flex">
                                                        <a class="close-input-xmark" href="javascript:void(0)"><i class="fa-solid fa-xmark"></i></a>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="detail-box">
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="px-4 position-relative">
                                                    <input class="form-control" value="<?php if (!empty($lead_detail->last_name)) {
                                                                                            echo $lead_detail->last_name;
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="px-4 position-relative">
                                                    <input class="form-control" value="<?php if (!empty($lead_detail->mobile_2)) {
                                                                                            echo $lead_detail->mobile_2;
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="px-4 position-relative">
                                                    <select class="form-control form-select" aria-label="Default select example" style="width: 300px;" id="lead_status">
                                                        <option value="1" <?php if ($lead_detail->lead_status == 1) {
                                                                                echo 'selected';
                                                                            } ?>>Call Back</option>
                                                        <option value="2" <?php if ($lead_detail->lead_status == 2) {
                                                                                echo 'selected';
                                                                            } ?>>Sale</option>
                                                        <option value="3" <?php if ($lead_detail->lead_status == 3) {
                                                                                echo 'selected';
                                                                            } ?>>Not Interested</option>
                                                        <option value="4" <?php if ($lead_detail->lead_status == 4) {
                                                                                echo 'selected';
                                                                            } ?>>VM</option>
                                                        <option value="5" <?php if ($lead_detail->lead_status == 5) {
                                                                                echo 'selected';
                                                                            } ?>>DND</option>
                                                    </select>
                                                    <i id="edit-field1" class="edit-field fa-solid fa-pencil none-icon"></i>
                ...
                <div id="notes-section" class="owner-detail note-area-box mb-4">
                    ...
                    <div class="d-flex pt-3 pb-2">
                        <div class="position-relative notes_manage">
                            <textarea class="form-control textarea-style" id="title" cols="80" row="5" placeholder="Add a note..." required style="height: 100px;"></textarea>
                            <input type="hidden" value="<?php if (!empty($lead_detail->user_id)) {
                                                            echo $lead_detail->user_id;
                                                        } ?>" id="user_id">
                            <input type="hidden" value="<?php if (!empty($lead_detail->id)) {
                                                            echo $lead_detail->id;
                                                        } ?>" id="module_id">
                            <input type="hidden" value="<?php if (!empty($lead_detail->user_type)) {
                                                            echo $lead_detail->user_type;
                                                        } ?>" id="module_type">
                            <input type="hidden" id="created_date" value="<?= date("F j, Y, g:i A"); ?>">
                            <input type="hidden" value="Lead" id="module_name">
                ...
                <div id="notes-sections" class="email-detail note-area-box mb-4">
                    <div class="border-btm d-flex justify-content-between">
                        ...
                        <div class="comp-email">
                            <a href="javascript:void(0)" class="btn tb_newsmallbtn sendmailbtn" id="<?php echo $lead_detail->id; ?>" data-bs-toggle="modal" data-bs-target="#myModal"> Compose Email</a>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-6" id="exampleModalLabel">Delete Note</h1>
