                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <p class=" fs-5 mt-2 mb-5">Verify by email or mobile no.</p>
                                        ...
                                        <?php echo form_open('Login/userVerifyReq'); ?>

                                        <div class="form-group mb-5">

                                            <input type="radio" name="verfication" value="email" required checked> <?=substr($email,0,4).'xxxxx'.substr($email,-12);?> <br>

                                            <input type="radio" name="verfication" value="mobile" required disabled> <?=substr($mobile,0,2).'XXXXXX'.substr($mobile,-2);?>

                                            <input type="hidden" name="user_id" value="<?php echo $user_detail;?>">

                                            <input type="hidden" name="user_detail" value="<?=$user_status;?>">
