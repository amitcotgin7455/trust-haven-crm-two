                            ...
                            <div class="row no-gutters">
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        ...
                                        <p class=" fs-5 mt-2 mb-5">Update Password</p>
                                        <?php if (!empty($this->session->flashdata('error'))) { ?>
                                            <h6 class="text-danger mt-4"> <?php echo  $this->session->flashdata('error'); ?> </h6>
                                        <?php } ?>
                                        <?php echo form_open('forget_password/change_password'); ?>
                                        <div class="form-group mb-5">
                                            <label for="exampleInputPassword1">New Password</label> 
                                            <input type="password" name="new_password" class="form-control" required id="exampleInputPassword1">
                                        ...
                                        <div class="form-group mb-5">
                                            ...
                                            <input type="password" name="confirm_password" class="form-control" required id="exampleInputPassword1">
