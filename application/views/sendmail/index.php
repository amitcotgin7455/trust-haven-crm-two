            ...
            <div class="col-8">
                <div class="send-to-id">
                    ...
                    <ul>
                        <li>
                            <span>
                                <?php if (!empty($user_detail[0]->first_name)) {
                                    echo $first_name;
                                } ?>
                    ...
                    <input type="email" name="toemail" id="toemail" value="<?php echo $user_detail[0]->email; ?>"hidden >
                </div>
            </div>
            <div class="col-4">
        ...
        <div class="row py-2 btm-border" id="thcemailCc" style="display: none;">
            <div class="col-8">
                <div class="send-to-id input-add">
                    ...
                    <input type="text" class="form-control" name="emailtocc" id="emailtocc">
                </div>
            </div>
            <div class="col-4">
        ...
        <div class="row py-2 btm-border" id="thcemailBcc" style="display: none;">
            <div class="col-8">
                <div class="send-to-id input-add">
                    ...
                    <input type="text" class="form-control" name="emailtobcc" id="emailtobcc">
                </div>
            </div>
            <div class="col-4">
...
<script>
    ...
    function valid_sendmail(){
        ...
        var body_data_length = $.trim(body_data); 
        var body_data_check_length = body_data_length.length;
        // alert(body_data_check_length);
        // return false;
        if(subject==''){
            alert('Please Fill Subject');
            return false;
        } else if(body_data_check_length==0){
