    ...
    r = function() {
        ...
        , function(e, t, n) {
            ...
            function o(e, t, n, r, o) {
                ...
                return e.addEventListener(n, c, o),
                {
                    destroy: function() {
...
, function(e, t, n) {
    ...
    var a, l = document.querySelector(".ccSection"), u = document.querySelector(".bccSection"), s = document.querySelector(".ccButton"), f = document.querySelector(".bccButton"), d = document.querySelectorAll(".input"), y = document.querySelector(".copyCode"), p = i(d);
    try {
        for (p.s(); !(a = p.n()).done; ) {
            a.value.addEventListener("keyup", (function(e) {
                var t = e.target.value
                  ...
                  , c = new RegExp(",");
                if (console.log(r, n, i, t),
                r.innerText = t,
                "recipient" != n && (t.length >= 1 ? i.classList.add("dib") : i.classList.remove("dib")),
                "recipient" == n || "cc" == n || "bcc" == n)
                    if (o.classList.add("active"),
                    c.test(t)) {
                        var a = r.innerHTML;
                        a = a.replace(/\s+/g, ""),
                        r.innerHTML = a
                        ...
                        r.innerHTML = t;
                if ("recipient" == n && (t.length >= 3 ? o.classList.add("active") : o.classList.remove("active")),
                "subject" == n || "body" == n) {
                    var l = r.innerText
    ...
    s.addEventListener("click", (function(e) {
        l.classList.contains("dn") ? (l.classList.remove("dn"),
        document.getElementById("cc").focus()) : l.classList.add("dn")
    }
    )),
    f.addEventListener("click", (function(e) {
        u.classList.contains("dn") ? (u.classList.remove("dn"),
        document.getElementById("bcc").focus()) : u.classList.add("dn")
    }
    ));
    var h = new o.a(".copyCode",{
        target: function(e) {
            return console.log(e.innerHTML = "Copied"),
            e.previousElementSibling
        }
    });
    h.on("success", (function(e, t) {
        for (var n = document.getElementsByClassName("copyCode"), r = 0; r < n.length; r += 1)
            n[r].innerHTML = "Copy";
        e.trigger.innerHTML = "Copied"
    }
    )),
    y.addEventListener("click", (function(e) {
        var t, n = document.querySelectorAll(".label.dib"), r = n[0], o = (document.querySelector(".label.dib"),
        n.length,
        i(n));
        try {
            for (o.s(); !(t = o.n()).done; ) {
...
, function(e, t) {
    ...
    function a() {
        n.matches ? (c(),
        localStorage.setItem("mode", "light")) : r.matches && (i(),
        localStorage.setItem("mode", "dark"))
    }
    "dark" == localStorage.getItem("mode") ? i() : "light" == localStorage.getItem("mode") || n.matches ? c() : r.matches && i(),
    o.addEventListener("click", (function() {
        document.body.classList.contains("light") ? (i(),
        localStorage.setItem("mode", "dark")) : (c(),
